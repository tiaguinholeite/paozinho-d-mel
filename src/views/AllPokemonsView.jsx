// src/views/AllPokemonsView.jsx
import { useEffect, useState } from 'react';
import axios from 'axios';
import PokemonCard from '../components/PokemonCard';
import { Link } from 'react-router-dom';

export default function AllPokemonsView() {
  ...
  className="bg-purple-800 text-white px-4 py-2 rounded border-2 border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-md"
>
  ...
  <option value="9">Geração 9 (Paldea)</option>
        ...
        {loading ? (
  <p className="text-center text-purple-300 text-lg">Carregando Pokémons...</p>
) : (
